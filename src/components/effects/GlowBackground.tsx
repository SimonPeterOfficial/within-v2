...
export default function GlowBackground({
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-28 left-[12%] h-80 w-80 rounded-full bg-[rgba(var(--mood-rgb),0.06)] blur-smoke" />
      <div className="absolute right-[8%] top-1/3 h-64 w-64 rounded-full bg-pink-600/[0.04] blur-smoke" />
      <div className="absolute bottom-[5%] left-[8%] h-60 w-60 rounded-full bg-emerald-600/[0.035] blur-smoke" />
